...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'solid', size = 'md', loading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      solid: 'bg-[var(--text-primary)] text-[var(--bg-primary)] hover:opacity-90',
      outline: 'border border-[var(--border-default)] hover:border-[var(--border-hover)] hover:bg-[var(--bg-tertiary)]',
